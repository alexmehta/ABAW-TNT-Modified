...
for epoch in range(epochs):
    ...
    for data in loop:
        ...
        loss_exp_6 = (au_detection_metric(result[:,14],au6.float()), loss_exp)
        loss_exp_7= (au_detection_metric(result[:,15],au7.float()), loss_exp)
        loss_exp_8 = (au_detection_metric(result[:,16],au8.float()), loss_exp)
        loss_exp_9 = (au_detection_metric(result[:,17],au9.float()), loss_exp)
        loss_exp_10 = (au_detection_metric(result[:,18],au10.float()), loss_exp)
        loss_exp_11 = (au_detection_metric(result[:,19],au11.float()), loss_exp)
